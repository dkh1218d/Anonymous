  ...
  if (product_list_slider.length) {
    product_list_slider.owlCarousel({
      ...
      (function() {
        ...
        var product_rate = $("[name='single_rate']").eq(0).val();
          ...
          function init(el) {
            ...
            function decrement() {
              ...
              if(!min || value >= min) {
                ...
                $("[name='total_rate']").eq(0).val(product_rate*value)
                $("#total_rate").html($("[name='total_rate']").eq(0).val());
                $("#sub_total").html($("[name='total_rate']").eq(0).val());
