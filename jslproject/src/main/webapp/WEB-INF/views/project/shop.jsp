            ...
            <div class="container">
                        ...
                        <form action="#">
                            <div class="select-itms">
                                <select name="select" id="select1">
                                    <option value="">10개 표시</option>
                                    <option value="">20개 표시</option>
                                    <option value="">30개 표시</option>
                                    <option value="">40개 표시</option>
                                </select>
                            </div>
                        </form>
                    </div>
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row">
                        	<c:forEach items="${shoplist}" var="sh"> 
								<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
	                                <div class="single-popular-items mb-50 text-center">
	                                    <div class="popular-img">
	                                        <img src="/project/image/${sh.image_alias}" alt="">
	                                        <div class="img-cap">
	                                    ...
	                                    <div class="popular-caption">
	                                        <h3><a href="product_details.jsp?conv">${sh.p_name }</a></h3>
	                                        <span>₩ ${String.format("%,d", sh.p_price)}</span>
	                                    </div>
	                                </div>
	                            </div>
                        	</c:forEach>
                        	<div class="more-imgs" data-no=2>
                        		<span>More</span>
                        	</div>
                        </div>
                    </div>
