                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                                <div class="hero__caption">
                                    ...
                                    <div class="hero__btn" data-animation="fadeInLeft" data-delay=".8s" data-duration="2000ms">
                                        <a href="industries.jsp?conv" class="btn hero-btn">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-new-pro mb-30 text-center">
                            ...
                            <div class="product-caption">
                                <h3><a href="product_details.jsp?conv">Thermo Ball Etip Gloves</a></h3>
                                <span>$ 45,743</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="room-btn pt-70">
                        <a href="catagori.jsp?conv" class="btn view-btn1">View More Products</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center justify-content-between padding-130">
                    <div class="col-lg-5 col-md-6">
                        <div class="watch-details mb-40">
                            ...
                            <a href="shop.jsp?conv" class="btn">Show Watches</a>
                        </div>
                    </div>
